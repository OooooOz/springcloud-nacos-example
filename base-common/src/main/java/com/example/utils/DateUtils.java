...
public class DateUtils {
    ...
    public static List<String> listFormatDate(Date startDate, Date endDate, DateType dateType) {
        ...
        endDate = getStartDate(endDate, dateType);
        int interval = 0;
        while (true) {
            Date tempDate = getStartDate(startDate, dateType, interval);
    ...
    public static int getWholeWeekOfYear(Date date) {
        Date endDateOfMonth = getEndDate(date, DateType.YEAR);
    ...
    public static int getWholeWeekOfMonth(Date date) {
        Date endDateOfMonth = getEndDate(date, DateType.MONTH);
    ...
    public static String getBackupMonth(Date date, DateType dateType) {
        ...
        Date currentMonth = getStartDate(new Date(), DateType.MONTH);
        String dateStr = dateToStr(date, "yyyy-MM");
    ...
    public static String getPastDateStr(int past, String customDate) {
        Calendar calendar = Calendar.getInstance();
        Date paramDate = getDateByStr(customDate);
